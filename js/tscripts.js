...
$(document).ready(function() {
    ...
    $('ul.tabs li').click(function() {
        ...
        var content = {
            'tab1': {
                'color_bg': '#dcdcdc',
                'big_head': 'Logo Design Packages',
                'mid_head': 'Special Packages for Incomparable <br> Brand Identity Solutions',
            ...
            'tab2': {
                'color_bg': '#dcdcdc',
                'big_head': 'Brand Design Packages',
                'mid_head': 'Special Packages for Incomparable <br> Brand Identity Solutions',
                'para': 'We’ve crafted some of the best logo design packages <br> for emerging startups, pre-existing brands and  world-class corporations. <br> Pick a suitable design package <br> below or discuss a custom quote with us today.'
            },
            ...
            'tab5': {
                'color_bg': '#dcdcdc',
                'big_head': 'sensation Design Packages',
                'mid_head': 'Special Packages for Incomparable <br> Brand Identity Solutions',
                'para': 'We’ve crafted some of the best logo design packages <br> for emerging startups, pre-existing brands and  world-class corporations. <br> Pick a suitable design package <br> below or discuss a custom quote with us today.'
            },
            ...
            'tab6': {
                'color_bg': '#dcdcdc',
                'big_head': 'Content Design Packages',
                'mid_head': 'Special Packages for Incomparable <br> Brand Identity Solutions',
                'para': 'We’ve crafted some of the best logo design packages <br> for emerging startups, pre-existing brands and  world-class corporations. <br> Pick a suitable design package <br> below or discuss a custom quote with us today.'
            },
            ...
            'tab7': {
                'color_bg': '#dcdcdc',
                'big_head': 'eCommerce Design Packages',
                'mid_head': 'Special Packages for Incomparable <br> Brand Identity Solutions',
                'para': 'We’ve crafted some of the best logo design packages <br> for emerging startups, pre-existing brands and  world-class corporations. <br> Pick a suitable design package <br> below or discuss a custom quote with us today.'
            },
            ...
            'tab8': {
                'color_bg': '#dcdcdc',
                'big_head': 'Marketing Design Packages',
                'mid_head': 'Special Packages for Incomparable <br> Brand Identity Solutions',
                'para': 'We’ve crafted some of the best logo design packages <br> for emerging startups, pre-existing brands and  world-class corporations. <br> Pick a suitable design package <br> below or discuss a custom quote with us today.'
            }
        };
    ...
    $('.btn-step-next').on('click', function(e) {
        ...
        $.ajax({
            ...
            error: function(errors) {
                console.log('POST request Failed with errors: ' + errors.responseText);
                console.log(data);
                console.log(data);
                console.log(errors);
            },
    ...
    moveCart: function(e) {
        if ($('.box-follow-scroll').length > 0) {
            ...
            if ((parseInt($('.box-follow-scroll')[0].offsetTop) < parseInt($(this).scrollTop())) && parseInt(offsetTop) < parseInt(parentHeight)) {
                $('.box-follow-scroll').stop(false, false).animate({
                    'top': $(this).scrollTop()
                });
            } else {
...
$('.membership-box span.more').on('click', function() {
    ...
    if ($('.methodology-slider').css('height') == "0") {
        var height = true;
        $('.membership-detail').each(function() {
            if ($(this).hasClass('in') && $(this).attr('id') != $self.parent().next().attr('id')) {
                height = false;
            }
            if (!$(this).hasClass('in')) {
                $('.membership-detail').hide();
            }

        });
        if (height) {
            $('.methodology-slider').animate({
                'height': '230px'
            });
        }
    } else {
