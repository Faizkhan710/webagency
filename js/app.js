...
! function(e) {
    ...
    o = function() {
        function o(o, i) {
            ...
            n.defaults = {
                ...
                arrows: !0,
                asNavFor: null,
                prevArrow: '<button type="button" data-role="none" class="sensation-prev" aria-label="Previous" tabindex="0" role="button">Previous</button>',
                nextArrow: '<button type="button" data-role="none" class="sensation-next" aria-label="Next" tabindex="0" role="button">Next</button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
                cssEase: "ease",
                customPaging: function(o, t) {
                    return e('<button type="button" data-role="none" role="button" tabindex="0" />').text(t + 1)
                },
                dots: !1,
                dotsClass: "sensation-dots",
                draggable: !0,
                easing: "linear",
                edgeFriction: .35,
                fade: !1,
        ...
        var e = this;
        e.$slideTrack.find(".sensation-active").attr({
            "aria-hidden": "false"
        }).find("a, input, button, select").attr({
            tabindex: "0"
        })
    }, o.prototype.addSlide = o.prototype.sensationAdd = function(o, t, i) {
        var s = this;
        if ("boolean" == typeof t) i = t, t = null;
        else if (0 > t || t >= s.slideCount) return !1;
        s.unload(), "number" == typeof t ? 0 === t && 0 === s.$slides.length ? e(o).appendTo(s.$slideTrack) : i ? e(o).insertBefore(s.$slides.eq(t)) : e(o).insertAfter(s.$slides.eq(t)) : i === !0 ? e(o).prependTo(s.$slideTrack) : e(o).appendTo(s.$slideTrack), s.$slides = s.$slideTrack.children(this.options.slide), s.$slideTrack.children(this.options.slide).detach(), s.$slideTrack.append(s.$slides), s.$slides.each(function(o, t) {
            e(t).attr("data-sensation-index", o)
        }), s.$slidesCache = s.$slides, s.reinit()
    }, o.prototype.animateHeight = function() {
        var e = this;
        if (1 === e.options.slidesToShow && e.options.adaptiveHeight === !0 && e.options.vertical === !1) {
            var o = e.$slides.eq(e.currentSlide).outerHeight(!0);
            e.$list.animate({
                height: o
            }, e.options.speed)
        }
    }, o.prototype.animateSlide = function(o, t) {
        var i = {},
            s = this;
        s.animateHeight(), s.options.rtl === !0 && s.options.vertical === !1 && (o = -o), s.transformsEnabled === !1 ? s.options.vertical === !1 ? s.$slideTrack.animate({
            left: o
        ...
        })) : (s.applyTransition(), o = Math.ceil(o), s.options.vertical === !1 ? i[s.animType] = "translate3d(" + o + "px, 0px, 0px)" : i[s.animType] = "translate3d(0px," + o + "px, 0px)", s.$slideTrack.css(i), t && setTimeout(function() {
            s.disableTransition(), t.call()
        }, s.options.speed))
    }, o.prototype.getNavTarget = function() {
        var o = this,
            t = o.options.asNavFor;
        return t && null !== t && (t = e(t).not(o.$slider)), t
    }, o.prototype.asNavFor = function(o) {
        var t = this,
            i = t.getNavTarget();
        null !== i && "object" == typeof i && i.each(function() {
            var t = e(this).sensation("getsensation");
            t.unsensationed || t.slideHandler(o, !0)
        })
    }, o.prototype.applyTransition = function(e) {
        var o = this,
            t = {};
        o.options.fade === !1 ? t[o.transitionType] = o.transformType + " " + o.options.speed + "ms " + o.options.cssEase : t[o.transitionType] = "opacity " + o.options.speed + "ms " + o.options.cssEase, o.options.fade === !1 ? o.$slideTrack.css(t) : o.$slides.eq(e).css(t)
        ...
        var e = this,
            o = e.currentSlide + e.options.slidesToScroll;
        e.paused || e.interrupted || e.focussed || (e.options.infinite === !1 && (1 === e.direction && e.currentSlide + 1 === e.slideCount - 1 ? e.direction = 0 : 0 === e.direction && (o = e.currentSlide - e.options.slidesToScroll, e.currentSlide - 1 === 0 && (e.direction = 1))), e.slideHandler(o))
    }, o.prototype.buildArrows = function() {
        var o = this;
        o.options.arrows === !0 && (o.$prevArrow = e(o.options.prevArrow).addClass("sensation-arrow"), o.$nextArrow = e(o.options.nextArrow).addClass("sensation-arrow"), o.slideCount > o.options.slidesToShow ? (o.$prevArrow.removeClass("sensation-hidden").removeAttr("aria-hidden tabindex"), o.$nextArrow.removeClass("sensation-hidden").removeAttr("aria-hidden tabindex"), o.htmlExpr.test(o.options.prevArrow) && o.$prevArrow.prependTo(o.options.appendArrows), o.htmlExpr.test(o.options.nextArrow) && o.$nextArrow.appendTo(o.options.appendArrows), o.options.infinite !== !0 && o.$prevArrow.addClass("sensation-disabled").attr("aria-disabled", "true")) : o.$prevArrow.add(o.$nextArrow).addClass("sensation-hidden").attr({
            "aria-disabled": "true",
            tabindex: "-1"
        }))
        ...
        if (i.options.dots === !0 && i.slideCount > i.options.slidesToShow) {
            for (i.$slider.addClass("sensation-dotted"), t = e("<ul />").addClass(i.options.dotsClass), o = 0; o <= i.getDotCount(); o += 1) t.append(e("<li />").append(i.options.customPaging.call(this, i, o)));
            i.$dots = t.appendTo(i.options.appendDots), i.$dots.find("li").first().addClass("sensation-active").attr("aria-hidden", "false")
        }
    }, o.prototype.buildOut = function() {
        var o = this;
        o.$slides = o.$slider.children(o.options.slide + ":not(.sensation-cloned)").addClass("sensation-slide"), o.slideCount = o.$slides.length, o.$slides.each(function(o, t) {
            e(t).attr("data-sensation-index", o).data("originalStyling", e(t).attr("style") || "")
        }), o.$slider.addClass("sensation-slider"), o.$slideTrack = 0 === o.slideCount ? e('<div class="sensation-track"/>').appendTo(o.$slider) : o.$slides.wrapAll('<div class="sensation-track"/>').parent(), o.$list = o.$slideTrack.wrap('<div aria-live="polite" class="sensation-list"/>').parent(), o.$slideTrack.css("opacity", 0), (o.options.centerMode === !0 || o.options.swipeToSlide === !0) && (o.options.slidesToScroll = 1), e("img[data-lazy]", o.$slider).not("[src]").addClass("sensation-loading"), o.setupInfinite(), o.buildArrows(), o.buildDots(), o.updateDots(), o.setSlideClasses("number" == typeof o.currentSlide ? o.currentSlide : 0), o.options.draggable === !0 && o.$list.addClass("draggable")
    }, o.prototype.buildRows = function() {
        var e, o, t, i, s, n, r, d = this;
        if (i = document.createDocumentFragment(), n = d.$slider.children(), d.options.rows > 1) {
            for (r = d.options.slidesPerRow * d.options.rows, s = Math.ceil(n.length / r), e = 0; s > e; e++) {
                var l = document.createElement("div");
                for (o = 0; o < d.options.rows; o++) {
                    var a = document.createElement("div");
                    for (t = 0; t < d.options.slidesPerRow; t++) {
                        var c = e * r + (o * d.options.slidesPerRow + t);
    ...
    }, o.prototype.checkResponsive = function(o, t) {
        var i, s, n, r = this,
            d = !1,
            l = r.$slider.width(),
            a = window.innerWidth || e(window).width();
        if ("window" === r.respondTo ? n = a : "slider" === r.respondTo ? n = l : "min" === r.respondTo && (n = Math.min(a, l)), r.options.responsive && r.options.responsive.length && null !== r.options.responsive) {
            s = null;
            for (i in r.breakpoints) r.breakpoints.hasOwnProperty(i) && (r.originalSettings.mobileFirst === !1 ? n < r.breakpoints[i] && (s = r.breakpoints[i]) : n > r.breakpoints[i] && (s = r.breakpoints[i]));
            null !== s ? null !== r.activeBreakpoint ? (s !== r.activeBreakpoint || t) && (r.activeBreakpoint = s, "unsensation" === r.breakpointSettings[s] ? r.unsensation(s) : (r.options = e.extend({}, r.originalSettings, r.breakpointSettings[s]), o === !0 && (r.currentSlide = r.options.initialSlide), r.refresh(o)), d = s) : (r.activeBreakpoint = s, "unsensation" === r.breakpointSettings[s] ? r.unsensation(s) : (r.options = e.extend({}, r.originalSettings, r.breakpointSettings[s]), o === !0 && (r.currentSlide = r.options.initialSlide), r.refresh(o)), d = s) : null !== r.activeBreakpoint && (r.activeBreakpoint = null, r.options = r.originalSettings, o === !0 && (r.currentSlide = r.options.initialSlide), r.refresh(o), d = s), o || d === !1 || r.$slider.trigger("breakpoint", [r, d])
        }
    }, o.prototype.changeSlide = function(o, t) {
        var i, s, n, r = this,
            d = e(o.currentTarget);
        switch (d.is("a") && o.preventDefault(), d.is("li") || (d = d.closest("li")), n = r.slideCount % r.options.slidesToScroll !== 0, i = n ? 0 : (r.slideCount - r.currentSlide) % r.options.slidesToScroll, o.data.message) {
            case "previous":
                s = 0 === i ? r.options.slidesToScroll : r.options.slidesToShow - i, r.slideCount > r.options.slidesToShow && r.slideHandler(r.currentSlide - s, !1, t);
                break;
            case "next":
                s = 0 === i ? r.options.slidesToScroll : i, r.slideCount > r.options.slidesToShow && r.slideHandler(r.currentSlide + s, !1, t);
                break;
            case "index":
                var l = 0 === o.data.index ? 0 : o.data.index || d.index() * r.options.slidesToScroll;
                r.slideHandler(r.checkNavigable(l), !1, t), d.children().trigger("focus");
                break;
            default:
                return
        }
        ...
        var o, t, i = this;
        if (o = i.getNavigableIndexes(), t = 0, e > o[o.length - 1]) e = o[o.length - 1];
        else
            for (var s in o) {
                if (e < o[s]) {
                    e = t;
        ...
        var o = this;
        o.options.dots && null !== o.$dots && e("li", o.$dots).off("click.sensation", o.changeSlide).off("mouseenter.sensation", e.proxy(o.interrupt, o, !0)).off("mouseleave.sensation", e.proxy(o.interrupt, o, !1)), o.$slider.off("focus.sensation blur.sensation"), o.options.arrows === !0 && o.slideCount > o.options.slidesToShow && (o.$prevArrow && o.$prevArrow.off("click.sensation", o.changeSlide), o.$nextArrow && o.$nextArrow.off("click.sensation", o.changeSlide)), o.$list.off("touchstart.sensation mousedown.sensation", o.swipeHandler), o.$list.off("touchmove.sensation mousemove.sensation", o.swipeHandler), o.$list.off("touchend.sensation mouseup.sensation", o.swipeHandler), o.$list.off("touchcancel.sensation mouseleave.sensation", o.swipeHandler), o.$list.off("click.sensation", o.clickHandler), e(document).off(o.visibilityChange, o.visibility), o.cleanUpSlideEvents(), o.options.accessibility === !0 && o.$list.off("keydown.sensation", o.keyHandler), o.options.focusOnSelect === !0 && e(o.$slideTrack).children().off("click.sensation", o.selectHandler), e(window).off("orientationchange.sensation.sensation-" + o.instanceUid, o.orientationChange), e(window).off("resize.sensation.sensation-" + o.instanceUid, o.resize), e("[draggable!=true]", o.$slideTrack).off("dragstart", o.preventDefault), e(window).off("load.sensation.sensation-" + o.instanceUid, o.setPosition)
    }, o.prototype.cleanUpSlideEvents = function() {
        var o = this;
        o.$list.off("mouseenter.sensation", e.proxy(o.interrupt, o, !0)), o.$list.off("mouseleave.sensation", e.proxy(o.interrupt, o, !1))
    }, o.prototype.cleanUpRows = function() {
        var e, o = this;
        o.options.rows > 1 && (e = o.$slides.children().children(), e.removeAttr("style"), o.$slider.empty().append(e))
    }, o.prototype.clickHandler = function(e) {
        var o = this;
        o.shouldClick === !1 && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault())
    }, o.prototype.destroy = function(o) {
        var t = this;
        t.autoPlayClear(), t.touchObject = {}, t.cleanUpEvents(), e(".sensation-cloned", t.$slider).detach(), t.$dots && t.$dots.remove(), t.$prevArrow && t.$prevArrow.length && (t.$prevArrow.removeClass("sensation-disabled sensation-arrow sensation-hidden").removeAttr("aria-hidden aria-disabled tabindex").css("display", ""), t.htmlExpr.test(t.options.prevArrow) && t.$prevArrow.remove()), t.$nextArrow && t.$nextArrow.length && (t.$nextArrow.removeClass("sensation-disabled sensation-arrow sensation-hidden").removeAttr("aria-hidden aria-disabled tabindex").css("display", ""), t.htmlExpr.test(t.options.nextArrow) && t.$nextArrow.remove()), t.$slides && (t.$slides.removeClass("sensation-slide sensation-active sensation-center sensation-visible sensation-current").removeAttr("aria-hidden").removeAttr("data-sensation-index").each(function() {
            e(this).attr("style", e(this).data("originalStyling"))
        }), t.$slideTrack.children(this.options.slide).detach(), t.$slideTrack.detach(), t.$list.detach(), t.$slider.append(t.$slides)), t.cleanUpRows(), t.$slider.removeClass("sensation-slider"), t.$slider.removeClass("sensation-initialized"), t.$slider.removeClass("sensation-dotted"), t.unsensationed = !0, o || t.$slider.trigger("destroy", [t])
    }, o.prototype.disableTransition = function(e) {
        var o = this,
            t = {};
        t[o.transitionType] = "", o.options.fade === !1 ? o.$slideTrack.css(t) : o.$slides.eq(e).css(t)
    }, o.prototype.fadeSlide = function(e, o) {
        var t = this;
        t.cssTransitions === !1 ? (t.$slides.eq(e).css({
            zIndex: t.options.zIndex
        }), t.$slides.eq(e).animate({
            opacity: 1
        }, t.options.speed, t.options.easing, o)) : (t.applyTransition(e), t.$slides.eq(e).css({
            opacity: 1,
            zIndex: t.options.zIndex
        }), o && setTimeout(function() {
            t.disableTransition(e), o.call()
        }, t.options.speed))
    }, o.prototype.fadeSlideOut = function(e) {
        var o = this;
        o.cssTransitions === !1 ? o.$slides.eq(e).animate({
            opacity: 0,
            zIndex: o.options.zIndex - 2
        }, o.options.speed, o.options.easing) : (o.applyTransition(e), o.$slides.eq(e).css({
            opacity: 0,
            zIndex: o.options.zIndex - 2
        }))
    }, o.prototype.filterSlides = o.prototype.sensationFilter = function(e) {
        var o = this;
        null !== e && (o.$slidesCache = o.$slides, o.unload(), o.$slideTrack.children(this.options.slide).detach(), o.$slidesCache.filter(e).appendTo(o.$slideTrack), o.reinit())
    }, o.prototype.focusHandler = function() {
        var o = this;
        o.$slider.off("focus.sensation blur.sensation").on("focus.sensation blur.sensation", "*:not(.sensation-arrow)", function(t) {
            t.stopImmediatePropagation();
            var i = e(this);
            setTimeout(function() {
                o.options.pauseOnFocus && (o.focussed = i.is(":focus"), o.autoPlay())
            }, 0)
        })
    }, o.prototype.getCurrent = o.prototype.sensationCurrentSlide = function() {
        var e = this;
        ...
        if (e.options.infinite === !0)
            for (; o < e.slideCount;) ++i, o = t + e.options.slidesToScroll, t += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
    ...
    }, o.prototype.getOption = o.prototype.sensationGetOption = function(e) {
        var o = this;
        return o.options[e]
        ...
        var e, o = this,
            ...
            i = 0,
            s = [];
        for (o.options.infinite === !1 ? e = o.slideCount : (t = -1 * o.options.slidesToScroll, i = -1 * o.options.slidesToScroll, e = 2 * o.slideCount); e > t;) s.push(t), t = i + o.options.slidesToScroll, i += o.options.slidesToScroll <= o.options.slidesToShow ? o.options.slidesToScroll : o.options.slidesToShow;
        return s
    }, o.prototype.getsensation = function() {
        return this
    }, o.prototype.getSlideCount = function() {
        var o, t, i, s = this;
        return i = s.options.centerMode === !0 ? s.slideWidth * Math.floor(s.options.slidesToShow / 2) : 0, s.options.swipeToSlide === !0 ? (s.$slideTrack.find(".sensation-slide").each(function(o, n) {
            return n.offsetLeft - i + e(n).outerWidth() / 2 > -1 * s.swipeLeft ? (t = n, !1) : void 0
        }), o = Math.abs(e(t).attr("data-sensation-index") - s.currentSlide) || 1) : s.options.slidesToScroll
    }, o.prototype.goTo = o.prototype.sensationGoTo = function(e, o) {
        var t = this;
        t.changeSlide({
            data: {
                message: "index",
        ...
        var t = this;
        e(t.$slider).hasClass("sensation-initialized") || (e(t.$slider).addClass("sensation-initialized"), t.buildRows(), t.buildOut(), t.setProps(), t.startLoad(), t.loadSlider(), t.initializeEvents(), t.updateArrows(), t.updateDots(), t.checkResponsive(!0), t.focusHandler()), o && t.$slider.trigger("init", [t]), t.options.accessibility === !0 && t.initADA(), t.options.autoplay && (t.paused = !1, t.autoPlay())
    }, o.prototype.initADA = function() {
        var o = this;
        o.$slides.add(o.$slideTrack.find(".sensation-cloned")).attr({
            "aria-hidden": "true",
            tabindex: "-1"
        }).find("a, input, button, select").attr({
            tabindex: "-1"
        }), o.$slideTrack.attr("role", "listbox"), o.$slides.not(o.$slideTrack.find(".sensation-cloned")).each(function(t) {
            e(this).attr("role", "option");
            var i = o.options.centerMode ? t : Math.floor(t / o.options.slidesToShow);
            o.options.dots === !0 && e(this).attr("aria-describedby", "sensation-slide" + o.instanceUid + i)
        }), null !== o.$dots && o.$dots.attr("role", "tablist").find("li").each(function(t) {
            e(this).attr({
                role: "presentation",
                "aria-selected": "false",
                "aria-controls": "navigation" + o.instanceUid + t,
                id: "sensation-slide" + o.instanceUid + t
            })
        }).first().attr("aria-selected", "true").end().find("button").attr("role", "button").end().closest("div").attr("role", "toolbar"), o.activateADA()
    }, o.prototype.initArrowEvents = function() {
        var e = this;
        e.options.arrows === !0 && e.slideCount > e.options.slidesToShow && (e.$prevArrow.off("click.sensation").on("click.sensation", {
            message: "previous"
        }, e.changeSlide), e.$nextArrow.off("click.sensation").on("click.sensation", {
            message: "next"
        }, e.changeSlide))
    }, o.prototype.initDotEvents = function() {
        var o = this;
        o.options.dots === !0 && o.slideCount > o.options.slidesToShow && e("li", o.$dots).on("click.sensation", {
            message: "index"
        }, o.changeSlide), o.options.dots === !0 && o.options.pauseOnDotsHover === !0 && e("li", o.$dots).on("mouseenter.sensation", e.proxy(o.interrupt, o, !0)).on("mouseleave.sensation", e.proxy(o.interrupt, o, !1))
    }, o.prototype.initSlideEvents = function() {
        var o = this;
        o.options.pauseOnHover && (o.$list.on("mouseenter.sensation", e.proxy(o.interrupt, o, !0)), o.$list.on("mouseleave.sensation", e.proxy(o.interrupt, o, !1)))
    }, o.prototype.initializeEvents = function() {
        var o = this;
        o.initArrowEvents(), o.initDotEvents(), o.initSlideEvents(), o.$list.on("touchstart.sensation mousedown.sensation", {
            action: "start"
        }, o.swipeHandler), o.$list.on("touchmove.sensation mousemove.sensation", {
            action: "move"
        }, o.swipeHandler), o.$list.on("touchend.sensation mouseup.sensation", {
            action: "end"
        }, o.swipeHandler), o.$list.on("touchcancel.sensation mouseleave.sensation", {
            action: "end"
        }, o.swipeHandler), o.$list.on("click.sensation", o.clickHandler), e(document).on(o.visibilityChange, e.proxy(o.visibility, o)), o.options.accessibility === !0 && o.$list.on("keydown.sensation", o.keyHandler), o.options.focusOnSelect === !0 && e(o.$slideTrack).children().on("click.sensation", o.selectHandler), e(window).on("orientationchange.sensation.sensation-" + o.instanceUid, e.proxy(o.orientationChange, o)), e(window).on("resize.sensation.sensation-" + o.instanceUid, e.proxy(o.resize, o)), e("[draggable!=true]", o.$slideTrack).on("dragstart", o.preventDefault), e(window).on("load.sensation.sensation-" + o.instanceUid, o.setPosition), e(document).ready(o.setPosition)
    }, o.prototype.initUI = function() {
        var e = this;
        e.options.arrows === !0 && e.slideCount > e.options.slidesToShow && (e.$prevArrow.show(), e.$nextArrow.show()), e.options.dots === !0 && e.slideCount > e.options.slidesToShow && e.$dots.show()
    }, o.prototype.keyHandler = function(e) {
        var o = this;
        e.target.tagName.match("TEXTAREA|INPUT|SELECT") || (37 === e.keyCode && o.options.accessibility === !0 ? o.changeSlide({
            data: {
                message: o.options.rtl === !0 ? "next" : "previous"
            }
        }) : 39 === e.keyCode && o.options.accessibility === !0 && o.changeSlide({
            data: {
        ...
        function o(o) {
            e("img[data-lazy]", o).each(function() {
                var o = e(this),
                ...
                n.onload = function() {
                    o.animate({
                        ...
                        i && (o.attr("srcset", i), s && o.attr("sizes", s)), o.attr("src", t).animate({
                            opacity: 1
                        }, 200, function() {
                            o.removeAttr("data-lazy data-srcset data-sizes").removeClass("sensation-loading")
                        }), r.$slider.trigger("lazyLoaded", [r, o, t])
                    })
                }, n.onerror = function() {
                    o.removeAttr("data-lazy").removeClass("sensation-loading").addClass("sensation-lazyload-error"), r.$slider.trigger("lazyLoadError", [r, o, t])
                }, n.src = t
            })
        }
        var t, i, s, n, r = this;
        if (r.options.centerMode === !0 ? r.options.infinite === !0 ? (s = r.currentSlide + (r.options.slidesToShow / 2 + 1), n = s + r.options.slidesToShow + 2) : (s = Math.max(0, r.currentSlide - (r.options.slidesToShow / 2 + 1)), n = 2 + (r.options.slidesToShow / 2 + 1) + r.currentSlide) : (s = r.options.infinite ? r.options.slidesToShow + r.currentSlide : r.currentSlide, n = Math.ceil(s + r.options.slidesToShow), r.options.fade === !0 && (s > 0 && s--, n <= r.slideCount && n++)), t = r.$slider.find(".sensation-slide").slice(s, n), "anticipated" === r.options.lazyLoad)
            for (var d = s - 1, l = n, a = r.$slider.find(".sensation-slide"), c = 0; c < r.options.slidesToScroll; c++) 0 > d && (d = r.slideCount - 1), t = t.add(a.eq(d)), t = t.add(a.eq(l)), d--, l++;
        o(t), r.slideCount <= r.options.slidesToShow ? (i = r.$slider.find(".sensation-slide"), o(i)) : r.currentSlide >= r.slideCount - r.options.slidesToShow ? (i = r.$slider.find(".sensation-cloned").slice(0, r.options.slidesToShow), o(i)) : 0 === r.currentSlide && (i = r.$slider.find(".sensation-cloned").slice(-1 * r.options.slidesToShow), o(i))
    }, o.prototype.loadSlider = function() {
        var e = this;
        e.setPosition(), e.$slideTrack.css({
            opacity: 1
        }), e.$slider.removeClass("sensation-loading"), e.initUI(), "progressive" === e.options.lazyLoad && e.progressiveLazyLoad()
    ...
    }, o.prototype.pause = o.prototype.sensationPause = function() {
        var e = this;
        e.autoPlayClear(), e.paused = !0
    }, o.prototype.play = o.prototype.sensationPlay = function() {
        var e = this;
        e.autoPlay(), e.options.autoplay = !0, e.paused = !1, e.focussed = !1, e.interrupted = !1
    }, o.prototype.postSlide = function(e) {
        var o = this;
        o.unsensationed || (o.$slider.trigger("afterChange", [o, e]), o.animating = !1, o.setPosition(), o.swipeLeft = null, o.options.autoplay && o.autoPlay(), o.options.accessibility === !0 && o.initADA())
    }, o.prototype.prev = o.prototype.sensationPrev = function() {
        var e = this;
        e.changeSlide({
            data: {
                message: "previous"
        ...
        e.preventDefault()
    }, o.prototype.progressiveLazyLoad = function(o) {
        o = o || 1;
        var t, i, s, n, r, d = this,
            l = e("img[data-lazy]", d.$slider);
        l.length ? (t = l.first(), i = t.attr("data-lazy"), s = t.attr("data-srcset"), n = t.attr("data-sizes") || d.$slider.attr("data-sizes"), r = document.createElement("img"), r.onload = function() {
            s && (t.attr("srcset", s), n && t.attr("sizes", n)), t.attr("src", i).removeAttr("data-lazy data-srcset data-sizes").removeClass("sensation-loading"), d.options.adaptiveHeight === !0 && d.setPosition(), d.$slider.trigger("lazyLoaded", [d, t, i]), d.progressiveLazyLoad()
        }, r.onerror = function() {
            3 > o ? setTimeout(function() {
                d.progressiveLazyLoad(o + 1)
            }, 500) : (t.removeAttr("data-lazy").removeClass("sensation-loading").addClass("sensation-lazyload-error"), d.$slider.trigger("lazyLoadError", [d, t, i]), d.progressiveLazyLoad())
        }, r.src = i) : d.$slider.trigger("allImagesLoaded", [d])
    }, o.prototype.refresh = function(o) {
        var t, i, s = this;
        i = s.slideCount - s.options.slidesToShow, !s.options.infinite && s.currentSlide > i && (s.currentSlide = i), s.slideCount <= s.options.slidesToShow && (s.currentSlide = 0), t = s.currentSlide, s.destroy(!0), e.extend(s, s.initials, {
            currentSlide: t
        }), s.init(), o || s.changeSlide({
            data: {
                message: "index",
                index: t
            }
        ...
        if ("array" === e.type(n) && n.length) {
            ...
            for (o in n)
                if (i = s.breakpoints.length - 1, n.hasOwnProperty(o)) {
                    for (t = n[o].breakpoint; i >= 0;) s.breakpoints[i] && s.breakpoints[i] === t && s.breakpoints.splice(i, 1), i--;
                    s.breakpoints.push(t), s.breakpointSettings[t] = n[o].settings
                }
            s.breakpoints.sort(function(e, o) {
                return s.options.mobileFirst ? e - o : o - e
            })
        }
    }, o.prototype.reinit = function() {
        var o = this;
        o.$slides = o.$slideTrack.children(o.options.slide).addClass("sensation-slide"), o.slideCount = o.$slides.length, o.currentSlide >= o.slideCount && 0 !== o.currentSlide && (o.currentSlide = o.currentSlide - o.options.slidesToScroll), o.slideCount <= o.options.slidesToShow && (o.currentSlide = 0), o.registerBreakpoints(), o.setProps(), o.setupInfinite(), o.buildArrows(), o.updateArrows(), o.initArrowEvents(), o.buildDots(), o.updateDots(), o.initDotEvents(), o.cleanUpSlideEvents(), o.initSlideEvents(), o.checkResponsive(!1, !0), o.options.focusOnSelect === !0 && e(o.$slideTrack).children().on("click.sensation", o.selectHandler), o.setSlideClasses("number" == typeof o.currentSlide ? o.currentSlide : 0), o.setPosition(), o.focusHandler(), o.paused = !o.options.autoplay, o.autoPlay(), o.$slider.trigger("reInit", [o])
    }, o.prototype.resize = function() {
        var o = this;
        e(window).width() !== o.windowWidth && (clearTimeout(o.windowDelay), o.windowDelay = window.setTimeout(function() {
            o.windowWidth = e(window).width(), o.checkResponsive(), o.unsensationed || o.setPosition()
        }, 50))
    }, o.prototype.removeSlide = o.prototype.sensationRemove = function(e, o, t) {
        var i = this;
        return "boolean" == typeof e ? (o = e, e = o === !0 ? 0 : i.slideCount - 1) : e = o === !0 ? --e : e, i.slideCount < 1 || 0 > e || e > i.slideCount - 1 ? !1 : (i.unload(), t === !0 ? i.$slideTrack.children().remove() : i.$slideTrack.children(this.options.slide).eq(e).remove(), i.$slides = i.$slideTrack.children(this.options.slide), i.$slideTrack.children(this.options.slide).detach(), i.$slideTrack.append(i.$slides), i.$slidesCache = i.$slides, void i.reinit())
    }, o.prototype.setCSS = function(e) {
        var o, t, i = this,
            s = {};
        i.options.rtl === !0 && (e = -e), o = "left" == i.positionProp ? Math.ceil(e) + "px" : "0px", t = "top" == i.positionProp ? Math.ceil(e) + "px" : "0px", s[i.positionProp] = e, i.transformsEnabled === !1 ? i.$slideTrack.css(s) : (s = {}, i.cssTransitions === !1 ? (s[i.animType] = "translate(" + o + ", " + t + ")", i.$slideTrack.css(s)) : (s[i.animType] = "translate3d(" + o + ", " + t + ", 0px)", i.$slideTrack.css(s)))
        ...
        })), e.listWidth = e.$list.width(), e.listHeight = e.$list.height(), e.options.vertical === !1 && e.options.variableWidth === !1 ? (e.slideWidth = Math.ceil(e.listWidth / e.options.slidesToShow), e.$slideTrack.width(Math.ceil(e.slideWidth * e.$slideTrack.children(".sensation-slide").length))) : e.options.variableWidth === !0 ? e.$slideTrack.width(5e3 * e.slideCount) : (e.slideWidth = Math.ceil(e.listWidth), e.$slideTrack.height(Math.ceil(e.$slides.first().outerHeight(!0) * e.$slideTrack.children(".sensation-slide").length)));
        var o = e.$slides.first().outerWidth(!0) - e.$slides.first().width();
        e.options.variableWidth === !1 && e.$slideTrack.children(".sensation-slide").width(e.slideWidth - o)
    }, o.prototype.setFade = function() {
        var o, t = this;
        t.$slides.each(function(i, s) {
            o = t.slideWidth * i * -1, t.options.rtl === !0 ? e(s).css({
                position: "relative",
                right: o,
                top: 0,
    ...
    }, o.prototype.setOption = o.prototype.sensationSetOption = function() {
        var o, t, i, s, n, r = this,
            d = !1;
        if ("object" === e.type(arguments[0]) ? (i = arguments[0], d = arguments[1], n = "multiple") : "string" === e.type(arguments[0]) && (i = arguments[0], s = arguments[1], d = arguments[2], "responsive" === arguments[0] && "array" === e.type(arguments[1]) ? n = "responsive" : "undefined" != typeof arguments[1] && (n = "single")), "single" === n) r.options[i] = s;
        else if ("multiple" === n) e.each(i, function(e, o) {
            r.options[e] = o
        });
            ...
            for (t in s)
                if ("array" !== e.type(r.options.responsive)) r.options.responsive = [s[t]];
                    ...
                    for (o = r.options.responsive.length - 1; o >= 0;) r.options.responsive[o].breakpoint === s[t].breakpoint && r.options.responsive.splice(o, 1), o--;
        ...
        e.positionProp = e.options.vertical === !0 ? "top" : "left", "top" === e.positionProp ? e.$slider.addClass("sensation-vertical") : e.$slider.removeClass("sensation-vertical"), (void 0 !== o.WebkitTransition || void 0 !== o.MozTransition || void 0 !== o.msTransition) && e.options.useCSS === !0 && (e.cssTransitions = !0), e.options.fade && ("number" == typeof e.options.zIndex ? e.options.zIndex < 3 && (e.options.zIndex = 3) : e.options.zIndex = e.defaults.zIndex), void 0 !== o.OTransform && (e.animType = "OTransform", e.transformType = "-o-transform", e.transitionType = "OTransition", void 0 === o.perspectiveProperty && void 0 === o.webkitPerspective && (e.animType = !1)), void 0 !== o.MozTransform && (e.animType = "MozTransform", e.transformType = "-moz-transform", e.transitionType = "MozTransition", void 0 === o.perspectiveProperty && void 0 === o.MozPerspective && (e.animType = !1)), void 0 !== o.webkitTransform && (e.animType = "webkitTransform", e.transformType = "-webkit-transform", e.transitionType = "webkitTransition", void 0 === o.perspectiveProperty && void 0 === o.webkitPerspective && (e.animType = !1)), void 0 !== o.msTransform && (e.animType = "msTransform", e.transformType = "-ms-transform",
            e.transitionType = "msTransition", void 0 === o.msTransform && (e.animType = !1)), void 0 !== o.transform && e.animType !== !1 && (e.animType = "transform", e.transformType = "transform", e.transitionType = "transition"), e.transformsEnabled = e.options.useTransform && null !== e.animType && e.animType !== !1
    }, o.prototype.setSlideClasses = function(e) {
        var o, t, i, s, n = this;
        t = n.$slider.find(".sensation-slide").removeClass("sensation-active sensation-center sensation-current").attr("aria-hidden", "true"), n.$slides.eq(e).addClass("sensation-current"), n.options.centerMode === !0 ? (o = Math.floor(n.options.slidesToShow / 2), n.options.infinite === !0 && (e >= o && e <= n.slideCount - 1 - o ? n.$slides.slice(e - o, e + o + 1).addClass("sensation-active").attr("aria-hidden", "false") : (i = n.options.slidesToShow + e, t.slice(i - o + 1, i + o + 2).addClass("sensation-active").attr("aria-hidden", "false")), 0 === e ? t.eq(t.length - 1 - n.options.slidesToShow).addClass("sensation-center") : e === n.slideCount - 1 && t.eq(n.options.slidesToShow).addClass("sensation-center")), n.$slides.eq(e).addClass("sensation-center")) : e >= 0 && e <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(e, e + n.options.slidesToShow).addClass("sensation-active").attr("aria-hidden", "false") : t.length <= n.options.slidesToShow ? t.addClass("sensation-active").attr("aria-hidden", "false") : (s = n.slideCount % n.options.slidesToShow, i = n.options.infinite === !0 ? n.options.slidesToShow + e : e, n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - e < n.options.slidesToShow ? t.slice(i - (n.options.slidesToShow - s), i + s).addClass("sensation-active").attr("aria-hidden", "false") : t.slice(i, i + n.options.slidesToShow).addClass("sensation-active").attr("aria-hidden", "false")), ("ondemand" === n.options.lazyLoad || "anticipated" === n.options.lazyLoad) && n.lazyLoad()
    }, o.prototype.setupInfinite = function() {
        var o, t, i, s = this;
        if (s.options.fade === !0 && (s.options.centerMode = !1), s.options.infinite === !0 && s.options.fade === !1 && (t = null, s.slideCount > s.options.slidesToShow)) {
            for (i = s.options.centerMode === !0 ? s.options.slidesToShow + 1 : s.options.slidesToShow, o = s.slideCount; o > s.slideCount - i; o -= 1) t = o - 1, e(s.$slides[t]).clone(!0).attr("id", "").attr("data-sensation-index", t - s.slideCount).prependTo(s.$slideTrack).addClass("sensation-cloned");
            for (o = 0; i > o; o += 1) t = o, e(s.$slides[t]).clone(!0).attr("id", "").attr("data-sensation-index", t + s.slideCount).appendTo(s.$slideTrack).addClass("sensation-cloned");
            s.$slideTrack.find(".sensation-cloned").find("[id]").each(function() {
                e(this).attr("id", "")
            })
        }
    }, o.prototype.interrupt = function(e) {
        var o = this;
        e || o.autoPlay(), o.interrupted = e
    }, o.prototype.selectHandler = function(o) {
        var t = this,
            i = e(o.target).is(".sensation-slide") ? e(o.target) : e(o.target).parents(".sensation-slide"),
            s = parseInt(i.attr("data-sensation-index"));
        return s || (s = 0), t.slideCount <= t.options.slidesToShow ? (t.setSlideClasses(s), void t.asNavFor(s)) : void t.slideHandler(s)
    }, o.prototype.slideHandler = function(e, o, t) {
        var i, s, n, r, d, l = null,
            a = this;
        return o = o || !1, a.animating === !0 && a.options.waitForAnimate === !0 || a.options.fade === !0 && a.currentSlide === e || a.slideCount <= a.options.slidesToShow ? void 0 : (o === !1 && a.asNavFor(e), i = e, l = a.getLeft(i), r = a.getLeft(a.currentSlide), a.currentLeft = null === a.swipeLeft ? r : a.swipeLeft, a.options.infinite === !1 && a.options.centerMode === !1 && (0 > e || e > a.getDotCount() * a.options.slidesToScroll) ? void(a.options.fade === !1 && (i = a.currentSlide, t !== !0 ? a.animateSlide(r, function() {
            a.postSlide(i)
        }) : a.postSlide(i))) : a.options.infinite === !1 && a.options.centerMode === !0 && (0 > e || e > a.slideCount - a.options.slidesToScroll) ? void(a.options.fade === !1 && (i = a.currentSlide, t !== !0 ? a.animateSlide(r, function() {
            a.postSlide(i)
        }) : a.postSlide(i))) : (a.options.autoplay && clearInterval(a.autoPlayTimer), s = 0 > i ? a.slideCount % a.options.slidesToScroll !== 0 ? a.slideCount - a.slideCount % a.options.slidesToScroll : a.slideCount + i : i >= a.slideCount ? a.slideCount % a.options.slidesToScroll !== 0 ? 0 : i - a.slideCount : i, a.animating = !0, a.$slider.trigger("beforeChange", [a, a.currentSlide, s]), n = a.currentSlide, a.currentSlide = s, a.setSlideClasses(a.currentSlide), a.options.asNavFor && (d = a.getNavTarget(), d = d.sensation("getsensation"), d.slideCount <= d.options.slidesToShow && d.setSlideClasses(a.currentSlide)), a.updateDots(), a.updateArrows(), a.options.fade === !0 ? (t !== !0 ? (a.fadeSlideOut(n), a.fadeSlide(s, function() {
            a.postSlide(s)
        ...
        var e = this;
        e.options.arrows === !0 && e.slideCount > e.options.slidesToShow && (e.$prevArrow.hide(), e.$nextArrow.hide()), e.options.dots === !0 && e.slideCount > e.options.slidesToShow && e.$dots.hide(), e.$slider.addClass("sensation-loading")
    }, o.prototype.swipeDirection = function() {
        var e, o, t, i, s = this;
        return e = s.touchObject.startX - s.touchObject.curX, o = s.touchObject.startY - s.touchObject.curY, t = Math.atan2(o, e), i = Math.round(180 * t / Math.PI), 0 > i && (i = 360 - Math.abs(i)), 45 >= i && i >= 0 ? s.options.rtl === !1 ? "left" : "right" : 360 >= i && i >= 315 ? s.options.rtl === !1 ? "left" : "right" : i >= 135 && 225 >= i ? s.options.rtl === !1 ? "right" : "left" : s.options.verticalSwiping === !0 ? i >= 35 && 135 >= i ? "down" : "up" : "vertical"
        ...
        if (i.touchObject.edgeHit === !0 && i.$slider.trigger("edge", [i, i.swipeDirection()]), i.touchObject.swipeLength >= i.touchObject.minSwipe) {
            ...
            "vertical" != t && (i.slideHandler(o), i.touchObject = {}, i.$slider.trigger("swipe", [i, t]))
        } else i.touchObject.startX !== i.touchObject.curX && (i.slideHandler(i.currentSlide), i.touchObject = {})
    }, o.prototype.swipeHandler = function(e) {
        var o = this;
        if (!(o.options.swipe === !1 || "ontouchend" in document && o.options.swipe === !1 || o.options.draggable === !1 && -1 !== e.type.indexOf("mouse"))) switch (o.touchObject.fingerCount = e.originalEvent && void 0 !== e.originalEvent.touches ? e.originalEvent.touches.length : 1, o.touchObject.minSwipe = o.listWidth / o.options.touchThreshold, o.options.verticalSwiping === !0 && (o.touchObject.minSwipe = o.listHeight / o.options.touchThreshold), e.data.action) {
            case "start":
                o.swipeStart(e);
                break;
            case "move":
        ...
        var o, t, i, s, n, r = this;
        return n = void 0 !== e.originalEvent ? e.originalEvent.touches : null, !r.dragging || n && 1 !== n.length ? !1 : (o = r.getLeft(r.currentSlide), r.touchObject.curX = void 0 !== n ? n[0].pageX : e.clientX, r.touchObject.curY = void 0 !== n ? n[0].pageY : e.clientY, r.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(r.touchObject.curX - r.touchObject.startX, 2))), r.options.verticalSwiping === !0 && (r.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(r.touchObject.curY - r.touchObject.startY, 2)))), t = r.swipeDirection(), "vertical" !== t ? (void 0 !== e.originalEvent && r.touchObject.swipeLength > 4 && e.preventDefault(), s = (r.options.rtl === !1 ? 1 : -1) * (r.touchObject.curX > r.touchObject.startX ? 1 : -1), r.options.verticalSwiping === !0 && (s = r.touchObject.curY > r.touchObject.startY ? 1 : -1), i = r.touchObject.swipeLength, r.touchObject.edgeHit = !1, r.options.infinite === !1 && (0 === r.currentSlide && "right" === t || r.currentSlide >= r.getDotCount() && "left" === t) && (i = r.touchObject.swipeLength * r.options.edgeFriction, r.touchObject.edgeHit = !0), r.options.vertical === !1 ? r.swipeLeft = o + i * s : r.swipeLeft = o + i * (r.$list.height() / r.listWidth) * s, r.options.verticalSwiping === !0 && (r.swipeLeft = o + i * s), r.options.fade === !0 || r.options.touchMove === !1 ? !1 : r.animating === !0 ? (r.swipeLeft = null, !1) : void r.setCSS(r.swipeLeft)) : void 0)
    }, o.prototype.swipeStart = function(e) {
        var o, t = this;
        return t.interrupted = !0, 1 !== t.touchObject.fingerCount || t.slideCount <= t.options.slidesToShow ? (t.touchObject = {}, !1) : (void 0 !== e.originalEvent && void 0 !== e.originalEvent.touches && (o = e.originalEvent.touches[0]), t.touchObject.startX = t.touchObject.curX = void 0 !== o ? o.pageX : e.clientX, t.touchObject.startY = t.touchObject.curY = void 0 !== o ? o.pageY : e.clientY, void(t.dragging = !0))
    }, o.prototype.unfilterSlides = o.prototype.sensationUnfilter = function() {
        var e = this;
        null !== e.$slidesCache && (e.unload(), e.$slideTrack.children(this.options.slide).detach(), e.$slidesCache.appendTo(e.$slideTrack), e.reinit())
    }, o.prototype.unload = function() {
        var o = this;
        e(".sensation-cloned", o.$slider).remove(), o.$dots && o.$dots.remove(), o.$prevArrow && o.htmlExpr.test(o.options.prevArrow) && o.$prevArrow.remove(), o.$nextArrow && o.htmlExpr.test(o.options.nextArrow) && o.$nextArrow.remove(), o.$slides.removeClass("sensation-slide sensation-active sensation-visible sensation-current").attr("aria-hidden", "true").css("width", "")
    }, o.prototype.unsensation = function(e) {
        var o = this;
        o.$slider.trigger("unsensation", [o, e]), o.destroy()
    }, o.prototype.updateArrows = function() {
        var e, o = this;
        e = Math.floor(o.options.slidesToShow / 2), o.options.arrows === !0 && o.slideCount > o.options.slidesToShow && !o.options.infinite && (o.$prevArrow.removeClass("sensation-disabled").attr("aria-disabled", "false"), o.$nextArrow.removeClass("sensation-disabled").attr("aria-disabled", "false"), 0 === o.currentSlide ? (o.$prevArrow.addClass("sensation-disabled").attr("aria-disabled", "true"), o.$nextArrow.removeClass("sensation-disabled").attr("aria-disabled", "false")) : o.currentSlide >= o.slideCount - o.options.slidesToShow && o.options.centerMode === !1 ? (o.$nextArrow.addClass("sensation-disabled").attr("aria-disabled", "true"), o.$prevArrow.removeClass("sensation-disabled").attr("aria-disabled", "false")) : o.currentSlide >= o.slideCount - 1 && o.options.centerMode === !0 && (o.$nextArrow.addClass("sensation-disabled").attr("aria-disabled", "true"), o.$prevArrow.removeClass("sensation-disabled").attr("aria-disabled", "false")))
    }, o.prototype.updateDots = function() {
        var e = this;
        null !== e.$dots && (e.$dots.find("li").removeClass("sensation-active").attr("aria-hidden", "true"), e.$dots.find("li").eq(Math.floor(e.currentSlide / e.options.slidesToScroll)).addClass("sensation-active").attr("aria-hidden", "false"))
    }, o.prototype.visibility = function() {
        var e = this;
        e.options.autoplay && (document[e.hidden] ? e.interrupted = !0 : e.interrupted = !1)
    }, e.fn.sensation = function() {
        var e, t, i = this,
            s = arguments[0],
            n = Array.prototype.slice.call(arguments, 1),
            r = i.length;
        for (e = 0; r > e; e++)
            if ("object" == typeof s || "undefined" == typeof s ? i[e].sensation = new o(i[e], s) : t = i[e].sensation[s].apply(i[e].sensation, n), "undefined" != typeof t) return t;
        return i
    }
});
